const data =`
{
 ...
 function toArray(){
   let titles = [];
   let obj =  jsonToObject(data) ; // convert json to object and save in obj variable
   
   for(let i in obj){ // for in loop is used for object
       //console.log(i) // cakes , biscuits , bread

       //console.log(obj[i].length) the length of each array 
       obj[i].forEach( function(food){  // food is each element inside the array 
           //console.log(food.title); each title inside the 3 arrays
           titles.push(food.title);           
