...
let person = {  name: "Sara", age : 36 , city : "Berlin" }


let myJson = JSON.stringify(person);  // convert to JSON
...
let jsonContent = '{  "name"  : "john" , "age" : 40 , "isProgrammer" : true }';

console.log('the content type is ',typeof jsonContent);

let obj = JSON.parse(jsonContent);   // convering to object 
console.log('the converted content type is ', typeof obj);
...
const recipesJson = JSON.parse(data);
